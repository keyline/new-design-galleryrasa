<?php
    ...
    define('SITE_URL', 'http://galleryrasa.com');
    define('ADMIN_URL', 'http://galleryrasa.com/admin');
   ...
   define("LOG_PATH", 'logs/');
    ...
    define('SHOW_ERR', false); //show database error. Set to true only when debugging
    ...
    date_default_timezone_set(@date_default_timezone_set("Asia/Kolkata"));
    ...
    */
    ...
    define('CAROUSEL_TBL', 'carousel_ecomc');
