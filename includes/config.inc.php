<?php
    ...
    define('ORG_SITE_URL', 'https://localhost/ritwika/new-design-galleryrasa/');
    define('SITE_URL', 'https://localhost/ritwika/new-design-galleryrasa/');
    define('ADMIN_URL', 'https://localhost/ritwika/new-design-galleryrasa/admin');
