<?php
    ...
    define('DB_NAME', 'gallary_rasa');
    define('ORG_SITE_URL', 'https://localhost/new-design-galleryrasa/');
    define('SITE_URL', 'https://localhost/new-design-galleryrasa/');
    define('ADMIN_URL', 'https://localhost/new-design-galleryrasa/admin');
