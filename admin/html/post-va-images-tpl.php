<div class="col-sm-9 col-md-9">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">Add Images&nbsp;&nbsp;<span>{ProductName}</span>&nbsp;&nbsp;|&nbsp;&nbsp;<span>{pagination}</span></h3>
        </div>
        <div class="panel-body">
            <div role="tabpanel">
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active"><a href="#artwork" aria-controls="va-artwork" role="tab" data-toggle="tab">Art Work</a></li>
                    <li role="presentation"><a href="#artistphoto" aria-controls="va-artistphoto" role="tab" data-toggle="tab">Artist Photograph</a></li>
                ...
                <!-- Tab panes -->
                <form id="va-images" role="form" action="visual-images" method="post">
                    <input type="hidden" name="product" value="{productID}">
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="artwork">
                            <p>&nbsp;</p>
                            <div class="col-md-12">
                                <div class="col-md-7">
                                    <div style="float: left; margin-right: 20px">
                                        <h3>Artwork Images</h3>
                                        <div id="va-artworkimages" class="html5_uploader" style="width: 500px; height: 330px;">Your browser doesn't support native upload.</div>
                                    </div>
                                </div>
                                <div class="col-md-5 pull-right parent-artwork">
                                    <h3>Available Artwork Images</h3>
                                    <div id="response-va-artwork" class="response">
                                        <ul></ul>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div role="tabpanel" class="tab-pane" id="artistphoto">
                            <p>&nbsp;</p>
                            <div class="col-md-12">
                                <div class="col-md-7">
                                    <div style="float: left; margin-right: 20px">
                                        <h3>Artist Photograph</h3>
                                        <div id="va_artistPhotograph" class="html5_uploader" style="width: 500px; height: 330px;">Your browser doesn't support native upload.</div>
                                    </div>
                                </div>
                                <div class="col-md-5 pull-right parent-synopsis">
                                    <h3>Available Artist Photograph</h3>
                                    <div id="response-va-artistphoto" class="response">
                                        <ul></ul>
        ...
        <!--Mapping images to the freshly uploaded data-->
        <div class="container">
            <h2>Find Available Images And Map Appropriately</h2>
            <!-- Trigger the modal with a button -->
            <button type="button" url="get-available-images.php" class="btn btn-info btn-sm" data-toggle="modal" data-target="#myModal"data-prodid="{data-prodid}">See Images</button>
            <br><br>
