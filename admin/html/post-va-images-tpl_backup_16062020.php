        ...
        <div class="panel-body">
            <div role="tabpanel">
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active"><a href="#home" aria-controls="va-images" role="tab" data-toggle="tab">Images</a></li>
                ...
                <!-- Tab panes -->
                <form id="memorabilia-images" role="form" action="visual-images" method="post">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-7">
                                    <div style="float: left; margin-right: 20px">
                                        <h3>Images</h3>
                                        <div id="visual-images" class="html5_uploader" style="width: 500px; height: 330px;">Your browser doesn't support native upload.</div>
                                    </div>
                                </div>
