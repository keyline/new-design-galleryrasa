<div class="col-sm-9 col-md-9">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">Add Files(PDF)&nbsp;&nbsp;<span>{ProductName}</span></h3> 
        </div>
        <div class="panel-body">
            <div class="col-md-12">
                <!-- Tab panes -->
                <div class="col-md-8 pdf-upload-ui">
                <form id="bibliography-pdf" role="form" action="bibliography-pdf" method="post">
                    <input type="hidden" name="product" value="{productID}">
                    <div id="pdf-bibliography" class="html5_uploader" style="width: 500px; height: 330px;">Your browser doesn't support native upload.</div>    
                </form>
                </div>
                <div class="col-md-4 pdf-preview">
                    <h3>Available Attachments</h3>
                                    <div id="response-bibliography" class="response">
                                        <ul></ul>
                                    </div>
                </div>
