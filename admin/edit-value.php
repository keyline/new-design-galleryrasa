...
<div class="col-sm-9 col-md-9">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div role="tabpanel">
                <form method="post" action="db-edit-value">
                    ...
                    if (isset($_SESSION['succes-edit'])) {
                        ...
                        if (isset($_GET['type'])) {
                            if ($_GET['type'] == 'vi') {
                                ...
                                <a href="list-attr-value?attr_id=<?php echo $attr_id; ?>&type=vi" class="btn btn-sm btn-success">Back</a>
                                <?php
                            } else {
                                ?>

                                <a href="list-attr-value?attr_id=<?php echo $attr_id; ?>&type=mb" class="btn btn-sm btn-success">Back</a>
                                <?php
                            }
                        } else {
                            ?>
                            <a href="list-attr-value?attr_id=<?php echo $attr_id; ?>" class="btn btn-sm btn-success">Back</a>
                            <?php
                        }
                        ?>
