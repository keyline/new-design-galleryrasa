        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title"> CMS -> Cafe's </h4> </div>
                <!--
...
<!--**************************** start content ***********************-->
<?php
$sq=mysqli_query($conn,"Select * from content_cafes where ID = '".$_REQUEST['Id']."'");
...
<form action="process.php" name="commentForm" class="cmxform" id="commentForm" method="post" enctype="multipart/form-data" >     
    <div align="center">
		<h2 align="left"><?= $_REQUEST['Action'] ?> <b>Cafe's</b> </h2>
        ...
        <div class="FomHolder">
            ...
            <div class="EachSectionForm">
				<br><br>
                <label>Content</label>
                <textarea class="textarea_editor form-control" rows="5" name="Banner_Line2" ><?php echo $fe['Banner_Line2'] ?></textarea>
            </div>
            
            
            <div class="EachSectionForm">
				<br><br>
                <label>Map(Embeded Map)</label>
                <input type="text" value="<?php echo $fe['Banner_Line3'] ?>" name="Banner_Line3">
            </div>
            <!--
            <div class="EachSectionForm">
				<br><br>
