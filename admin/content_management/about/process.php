...
if(isset($_REQUEST['UpdateADD']) && $_REQUEST['UpdateADD'] == 'Update')
{
	...
	$flds = "`Banner_Line1`									= '".mysqli_real_escape_string($conn,$_REQUEST['Banner_Line1'])."',
			 ...
			 `Banner_Line4`									= '".mysqli_real_escape_string($conn,$_REQUEST['Banner_Line4'])."',
			 `Banner_Line5`									= '".mysqli_real_escape_string($conn,$_REQUEST['Banner_Line5'])."',
			 `Banner_Image`									= '".$file_name."'";
			
	$sql="UPDATE content_about SET $flds where ID = '".$_REQUEST['Id']."';" or die(mysqli_error($conn));
...
{
	$sql="Delete  from content_about where ID = '".$_REQUEST['Id']."';" or die(mysql_error($conn));
	if(mysqli_query($conn,$sql))
	{
...
if(isset($_REQUEST['UpdateADD']) && $_REQUEST['UpdateADD'] == 'Add New')
{
	...
	$sql="INSERT INTO content_about SET $flds;" or die(mysqli_error($conn));
