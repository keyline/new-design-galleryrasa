...
$va_archivistremarksarr = va_archivistremarks($prod_id);
$va_noofpublicationsarr = va_noofpublications($prod_id);
...
//    }
    ...
    $lastattrvalarr = lastinsertattrval(205);
...
//        }
        ...
        $lastattrvalarr2 = lastinsertattrval(227);
...
if ($addflag == false) {
    ...
    goto_location('edit-archivist-remarks.php?prod_id=' . $prod_id);
} else {
