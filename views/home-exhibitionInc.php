                    ...
                    <div class="tab-content" id="pills-tabContent">                        
                                                ...
                                                <div class="artist-box-info">
                                                    ...
                                                    <div class="exhibition-info">
                                                        ...
                                                        <div class="artist-year">
                                                            <?php 
                                                            $date_time = $v['from_exhibition_date'];
                                                            $dt = $v['end_exhibition_date'];
                            ...
                            <div class="artist-inner">
                                <div class="artist-info">
                                    <?php                                   
                                        foreach($exrow1 as $k) { ?>
                                    <div class="artist-box-doc">
                                        <a href="<?php SITE_URL ?>./exhibition-details.php?id=<?php echo $k['id']; ?>">
                                            <div class="artist-box">
                                                <div class="artist-box-info">
                                                    <div class="artist-img">
                        ...
                        <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                            <div class="artist-inner">
                                <div class="artist-info">
                                    <?php                                   
                                        foreach($exrow2 as $key) { ?>
                                    <div class="artist-box-doc">
                                        <a href="<?php SITE_URL ?>./exhibition-details.php?id=<?php echo $key['id']; ?>">
                                            <div class="artist-box">
                                                <div class="artist-box-info">
                                                    <div class="artist-img">
                                                        <img class="img-fluid" src="<?php echo SITE_URL . '/' . EXHIBITION_THUMB_IMGS . $key['photo']; ?>">
                                                    </div>
                                                    <div class="exhibition-info">
                                                        <div class="exhibition-content">
                                                        ...
                                                        <div class="artist-year">
                                                            <?php 
                                                            $date_time = $key['from_exhibition_date'];
                                                            $dt = $key['end_exhibition_date'];
                                                            $date_time = strtotime(str_replace(',', '', $date_time));
                                                            $date = date('d M Y',$date_time);
                                                            $time = date('h:i A',$date_time);
                                                            $dt = strtotime(str_replace(',', '', $dt));
