                    ...
                    <div class="right-details">
                     <div class="exhibition-search-title">
                        ...
                        <div class="exhibition-search-info">
                            <ul>
                                <li><span class="material-icons">calendar_month</span><?php echo $k['from_exhibition_date'] .' to '. $k['end_exhibition_date'];?></li>
                                <!-- <li><span class="material-icons">watch_later</span>11:00 HRS - 18:00 HRS IST</li> -->
