            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="visual-inner">
                        <!--
                        <div class="visual-ban">
                            <img class="img-fluid" src="assets/img/Rectangle 105.jpg" alt="">
                        </div>
-->
                        <div class="row">
    ...
    <!--
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#advancedModal">
  Launch demo modal
</button>
-->
