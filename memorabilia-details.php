...
WHERE t.product_id =" . $pid . ")) as tbl2 GROUP BY tbl2.n, tbl2.an ORDER BY tbl2.pos ASC";
    ...
    //Sorting data Director/Cast/Editor
    //Added on 15/12/2022 by shuvadeep@keylines.net
    $order=array('Director', 'Cast', 'Editor');
